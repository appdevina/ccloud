        ...
        <div class="container-fluid">
          ...
          <div class="row pt-0">
            <div class="col-lg-12 col-md-12 ps-md-5 mb-5 mb-md-0 mt-5">
                <div class="p-4">
                    <form action="/visibility" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form-group">
                            <label for="inputVisibility" class="form-label">Visibility</label><br>
                            <input type="file" name="visibility" class="form-control-file" >
                        </div>
